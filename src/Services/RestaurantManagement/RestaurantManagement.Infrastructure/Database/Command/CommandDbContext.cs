...
namespace RestaurantManagement.Infrastructure.Database.Command;

public class CommandDbContext(DbContextOptions options, IMediator _mediator)
    : DbContext(options), IUnitOfWork, IEventLogUnitOfWork
{
